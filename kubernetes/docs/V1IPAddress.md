...
v1_ip_address_instance = V1IPAddress.from_json(json)
# print the JSON string representation of the object
print(V1IPAddress.to_json())

# convert the object into a dict
v1_ip_address_dict = v1_ip_address_instance.to_dict()
# create an instance of V1IPAddress from a dict
v1_ip_address_from_dict = V1IPAddress.from_dict(v1_ip_address_dict)
```

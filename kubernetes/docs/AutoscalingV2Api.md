# kubernetes.client.AutoscalingV2Api
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutoscalingV2Api->create_namespaced_horizontal_pod_autoscaler:\n")
        pprint(api_response)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutoscalingV2Api->delete_collection_namespaced_horizontal_pod_autoscaler:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutoscalingV2Api->delete_namespaced_horizontal_pod_autoscaler:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutoscalingV2Api->get_api_resources:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutoscalingV2Api->list_horizontal_pod_autoscaler_for_all_namespaces:\n")
        pprint(api_response)
    except Exception as e:
...
> V2HorizontalPodAutoscalerList list_namespaced_horizontal_pod_autoscaler(namespace, pretty=pretty, allow_watch_bookmarks=allow_watch_bookmarks, var_continue=var_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, resource_version_match=resource_version_match, send_initial_events=send_initial_events, timeout_seconds=timeout_seconds, watch=watch)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutoscalingV2Api->list_namespaced_horizontal_pod_autoscaler:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutoscalingV2Api->patch_namespaced_horizontal_pod_autoscaler:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutoscalingV2Api->patch_namespaced_horizontal_pod_autoscaler_status:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutoscalingV2Api->read_namespaced_horizontal_pod_autoscaler:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutoscalingV2Api->read_namespaced_horizontal_pod_autoscaler_status:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutoscalingV2Api->replace_namespaced_horizontal_pod_autoscaler:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutoscalingV2Api->replace_namespaced_horizontal_pod_autoscaler_status:\n")
        pprint(api_response)
    except Exception as e:

...
v1alpha3_device_request_instance = V1alpha3DeviceRequest.from_json(json)
# print the JSON string representation of the object
print(V1alpha3DeviceRequest.to_json())

# convert the object into a dict
v1alpha3_device_request_dict = v1alpha3_device_request_instance.to_dict()
# create an instance of V1alpha3DeviceRequest from a dict
v1alpha3_device_request_from_dict = V1alpha3DeviceRequest.from_dict(v1alpha3_device_request_dict)
```

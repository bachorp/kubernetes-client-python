...
v1_topology_spread_constraint_instance = V1TopologySpreadConstraint.from_json(json)
# print the JSON string representation of the object
print(V1TopologySpreadConstraint.to_json())

# convert the object into a dict
v1_topology_spread_constraint_dict = v1_topology_spread_constraint_instance.to_dict()
# create an instance of V1TopologySpreadConstraint from a dict
v1_topology_spread_constraint_from_dict = V1TopologySpreadConstraint.from_dict(v1_topology_spread_constraint_dict)
```

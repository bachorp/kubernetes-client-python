...
json = "{}"
# create an instance of V1beta2DeviceSubRequest from a JSON string
v1beta2_device_sub_request_instance = V1beta2DeviceSubRequest.from_json(json)
# print the JSON string representation of the object
print(V1beta2DeviceSubRequest.to_json())

# convert the object into a dict
v1beta2_device_sub_request_dict = v1beta2_device_sub_request_instance.to_dict()
# create an instance of V1beta2DeviceSubRequest from a dict
v1beta2_device_sub_request_from_dict = V1beta2DeviceSubRequest.from_dict(v1beta2_device_sub_request_dict)
```

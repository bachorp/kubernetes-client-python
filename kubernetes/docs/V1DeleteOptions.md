...
v1_delete_options_instance = V1DeleteOptions.from_json(json)
# print the JSON string representation of the object
print(V1DeleteOptions.to_json())

# convert the object into a dict
v1_delete_options_dict = v1_delete_options_instance.to_dict()
# create an instance of V1DeleteOptions from a dict
v1_delete_options_from_dict = V1DeleteOptions.from_dict(v1_delete_options_dict)
```

...
class CustomObjectsApi:
    ...
    def list_custom_object_for_all_namespaces(
        ...
        group: Annotated[StrictStr, Field(description="The custom resource's group name")],
        version: Annotated[StrictStr, Field(description="The custom resource's version")],
        resource_plural: Annotated[StrictStr, Field(description="The custom resource's plural name. For TPRs this would be lowercase plural kind.")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. If the feature gate WatchBookmarks is not enabled in apiserver, this field is ignored.")] = None,
        var_continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        field_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their fields. Defaults to everything.")] = None,
        ...
        _param = self._list_custom_object_for_all_namespaces_serialize(
            group=group,
            version=version,
    ...
    @validate_call
    def list_custom_object_for_all_namespaces_with_http_info(
        self,
        group: Annotated[StrictStr, Field(description="The custom resource's group name")],
        version: Annotated[StrictStr, Field(description="The custom resource's version")],
        resource_plural: Annotated[StrictStr, Field(description="The custom resource's plural name. For TPRs this would be lowercase plural kind.")],
    ...
    @validate_call
    def list_custom_object_for_all_namespaces_without_preload_content(
        self,
        group: Annotated[StrictStr, Field(description="The custom resource's group name")],
        version: Annotated[StrictStr, Field(description="The custom resource's version")],
        resource_plural: Annotated[StrictStr, Field(description="The custom resource's plural name. For TPRs this would be lowercase plural kind.")],
    ...
    def _list_custom_object_for_all_namespaces_serialize(
        self,
        group,
        version,
        resource_plural,
        ...
        if version is not None:
            _path_params['version'] = version
        if resource_plural is not None:
            _path_params['resource_plural'] = resource_plural
        # process the query parameters
        if pretty is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/apis/{group}/{version}/{resource_plural}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _patch_cluster_custom_object_serialize(
        ...
        if _content_type:
            ...
            _default_content_type = 'application/merge-patch+json'

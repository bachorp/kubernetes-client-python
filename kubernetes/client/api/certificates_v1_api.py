...
class CertificatesV1Api:
    ...
    def delete_collection_certificate_signing_request(
        ...
        _param = self._delete_collection_certificate_signing_request_serialize(
            pretty=pretty,
    ...
    @validate_call
    def delete_collection_certificate_signing_request_without_preload_content(
        self,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        var_continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        dry_run: Annotated[Optional[StrictStr], Field(description="When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed")] = None,
    ...
    def list_certificate_signing_request(
        ...
        _param = self._list_certificate_signing_request_serialize(
            pretty=pretty,
    ...
    @validate_call
    def list_certificate_signing_request_with_http_info(
        self,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        var_continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
    ...
    @validate_call
    def list_certificate_signing_request_without_preload_content(
        self,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        var_continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
    ...
    def _list_certificate_signing_request_serialize(
        self,
        pretty,
    ...
    def patch_certificate_signing_request_approval(
        ...
        _param = self._patch_certificate_signing_request_approval_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call
    def patch_certificate_signing_request_approval_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the CertificateSigningRequest")],
        body: Dict[str, Any],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    @validate_call
    def patch_certificate_signing_request_approval_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the CertificateSigningRequest")],
        body: Dict[str, Any],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    def _patch_certificate_signing_request_approval_serialize(
        self,
        name,
        body,
        pretty,
    ...
    def patch_certificate_signing_request_status(
        ...
        _param = self._patch_certificate_signing_request_status_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call
    def patch_certificate_signing_request_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the CertificateSigningRequest")],
        body: Dict[str, Any],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    @validate_call
    def patch_certificate_signing_request_status_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the CertificateSigningRequest")],
        body: Dict[str, Any],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    def _patch_certificate_signing_request_status_serialize(
        self,
        name,
        body,
        pretty,
    ...
    def read_certificate_signing_request_approval(
        ...
        _param = self._read_certificate_signing_request_approval_serialize(
            name=name,
            pretty=pretty,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def read_certificate_signing_request_approval_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the CertificateSigningRequest")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def read_certificate_signing_request_approval_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the CertificateSigningRequest")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def read_certificate_signing_request_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the CertificateSigningRequest")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def read_certificate_signing_request_status_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the CertificateSigningRequest")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
        _request_timeout: Union[
    ...
    def _read_certificate_signing_request_status_serialize(
        self,
        name,
        pretty,
        _request_auth,
    ...
    def replace_certificate_signing_request_approval(
        ...
        _param = self._replace_certificate_signing_request_approval_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call
    def replace_certificate_signing_request_approval_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the CertificateSigningRequest")],
        body: V1CertificateSigningRequest,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    def _replace_certificate_signing_request_approval_serialize(
        self,
        name,
        body,
        pretty,
    ...
    @validate_call
    def replace_certificate_signing_request_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the CertificateSigningRequest")],
        body: V1CertificateSigningRequest,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    @validate_call
    def replace_certificate_signing_request_status_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the CertificateSigningRequest")],
        body: V1CertificateSigningRequest,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).")] = None,
    ...
    def _replace_certificate_signing_request_status_serialize(
        self,
        name,
        body,
        pretty,

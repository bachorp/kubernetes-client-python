...
class V1CustomResourceColumnDefinition(BaseModel):
    ...
    json_path: StrictStr = Field(description="jsonPath is a simple JSON path (i.e. with array notation) which is evaluated against each custom resource to produce the value for this column.", alias="jsonPath")

...
class V1alpha1StorageVersion(BaseModel):
    ...
    spec: Dict[str, Any] = Field(description="Spec is an empty spec. It is here to comply with Kubernetes API style.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": obj.get("spec"),
            "status": V1alpha1StorageVersionStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

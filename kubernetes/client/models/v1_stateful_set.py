...
class V1StatefulSet(BaseModel):
    ...
    spec: Optional[V1StatefulSetSpec] = None
    status: Optional[V1StatefulSetStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1StatefulSetSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1StatefulSetStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

...
class V1ReplicaSetStatus(BaseModel):
    ...
    """ # noqa: E501
    available_replicas: Optional[StrictInt] = Field(default=None, description="The number of available non-terminating pods (ready for at least minReadySeconds) for this replica set.", alias="availableReplicas")
    ...
    fully_labeled_replicas: Optional[StrictInt] = Field(default=None, description="The number of non-terminating pods that have labels matching the labels of the pod template of the replicaset.", alias="fullyLabeledReplicas")

...
class V1ResourceQuota(BaseModel):
    ...
    spec: Optional[V1ResourceQuotaSpec] = None
    status: Optional[V1ResourceQuotaStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1ResourceQuotaSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1ResourceQuotaStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

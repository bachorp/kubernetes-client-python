...
class V1ValidatingAdmissionPolicyList(BaseModel):
    ...
    items: List[V1ValidatingAdmissionPolicy] = Field(description="List of ValidatingAdmissionPolicy.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1ValidatingAdmissionPolicy.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),

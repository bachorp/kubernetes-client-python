...
class V1beta2Device(BaseModel):
    ...
    taints: Optional[List[V1beta2DeviceTaint]] = Field(default=None, description="If specified, these are the driver-defined taints.  The maximum number of taints is 4.  This is an alpha field and requires enabling the DRADeviceTaints feature gate.")
    __properties: ClassVar[List[str]] = ["allNodes", "attributes", "capacity", "consumesCounters", "name", "nodeName", "nodeSelector", "taints"]

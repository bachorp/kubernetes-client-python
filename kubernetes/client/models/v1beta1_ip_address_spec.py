...
class V1beta1IPAddressSpec(BaseModel):
    ...
    """ # noqa: E501
    parent_ref: V1beta1ParentReference = Field(alias="parentRef")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parentRef": V1beta1ParentReference.from_dict(obj["parentRef"]) if obj.get("parentRef") is not None else None
        })
        return _obj

...
class V1beta1AllocationResult(BaseModel):
    ...
    """ # noqa: E501
    devices: Optional[V1beta1DeviceAllocationResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": V1beta1DeviceAllocationResult.from_dict(obj["devices"]) if obj.get("devices") is not None else None,

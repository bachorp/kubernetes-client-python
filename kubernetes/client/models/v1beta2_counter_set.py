...
class V1beta2CounterSet(BaseModel):
    ...
    """ # noqa: E501
    counters: Dict[str, V1beta2Counter] = Field(description="Counters defines the set of counters for this CounterSet The name of each counter must be unique in that set and must be a DNS label.  The maximum number of counters in all sets is 32.")
    name: StrictStr = Field(description="Name defines the name of the counter set. It must be a DNS label.")

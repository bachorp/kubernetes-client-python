...
class V1ValidatingAdmissionPolicyStatus(BaseModel):
    ...
    type_checking: Optional[V1TypeChecking] = Field(default=None, alias="typeChecking")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "typeChecking": V1TypeChecking.from_dict(obj["typeChecking"]) if obj.get("typeChecking") is not None else None
        })
        return _obj

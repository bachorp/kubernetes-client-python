...
class V1PodDisruptionBudget(BaseModel):
    ...
    spec: Optional[V1PodDisruptionBudgetSpec] = None
    status: Optional[V1PodDisruptionBudgetStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1PodDisruptionBudgetSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1PodDisruptionBudgetStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

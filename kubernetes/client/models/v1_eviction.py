...
class V1Eviction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["apiVersion", "deleteOptions", "kind", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deleteOptions": V1DeleteOptions.from_dict(obj["deleteOptions"]) if obj.get("deleteOptions") is not None else None,
            "kind": obj.get("kind"),

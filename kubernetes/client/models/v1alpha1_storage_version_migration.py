...
class V1alpha1StorageVersionMigration(BaseModel):
    ...
    spec: Optional[V1alpha1StorageVersionMigrationSpec] = None
    status: Optional[V1alpha1StorageVersionMigrationStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1alpha1StorageVersionMigrationSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1alpha1StorageVersionMigrationStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

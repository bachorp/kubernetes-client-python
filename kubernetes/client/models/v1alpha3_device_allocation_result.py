...
class V1alpha3DeviceAllocationResult(BaseModel):
    ...
    """ # noqa: E501
    config: Optional[List[V1alpha3DeviceAllocationConfiguration]] = Field(default=None, description="This field is a combination of all the claim and class configuration parameters. Drivers can distinguish between those based on a flag.  This includes configuration parameters for drivers which have no allocated devices in the result because it is up to the drivers which configuration parameters they support. They can silently ignore unknown configuration parameters.")
    results: Optional[List[V1alpha3DeviceRequestAllocationResult]] = Field(default=None, description="Results lists all allocated devices.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": [V1alpha3DeviceAllocationConfiguration.from_dict(_item) for _item in obj["config"]] if obj.get("config") is not None else None,
            "results": [V1alpha3DeviceRequestAllocationResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj

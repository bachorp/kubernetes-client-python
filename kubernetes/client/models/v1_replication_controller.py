...
class V1ReplicationController(BaseModel):
    ...
    spec: Optional[V1ReplicationControllerSpec] = None
    status: Optional[V1ReplicationControllerStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1ReplicationControllerSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1ReplicationControllerStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

...
class V1beta1LeaseCandidateSpec(BaseModel):
    ...
    """ # noqa: E501
    binary_version: StrictStr = Field(description="BinaryVersion is the binary version. It must be in a semver format without leading `v`. This field is required.", alias="binaryVersion")
    ...
    lease_name: StrictStr = Field(description="LeaseName is the name of the lease for which this candidate is contending. The limits on this field are the same as on Lease.name. Multiple lease candidates may reference the same Lease.name. This field is immutable.", alias="leaseName")

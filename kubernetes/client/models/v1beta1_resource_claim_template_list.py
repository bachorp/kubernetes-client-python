...
class V1beta1ResourceClaimTemplateList(BaseModel):
    ...
    items: List[V1beta1ResourceClaimTemplate] = Field(description="Items is the list of resource claim templates.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1beta1ResourceClaimTemplate.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),

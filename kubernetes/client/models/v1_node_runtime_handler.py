...
class V1NodeRuntimeHandler(BaseModel):
    ...
    """ # noqa: E501
    features: Optional[V1NodeRuntimeHandlerFeatures] = None
    name: Optional[StrictStr] = Field(default=None, description="Runtime handler name. Empty for the default runtime handler.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "features": V1NodeRuntimeHandlerFeatures.from_dict(obj["features"]) if obj.get("features") is not None else None,
            "name": obj.get("name")
        })
        return _obj

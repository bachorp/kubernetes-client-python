...
class V1alpha1MutatingAdmissionPolicyBindingSpec(BaseModel):
    ...
    policy_name: Optional[StrictStr] = Field(default=None, description="policyName references a MutatingAdmissionPolicy name which the MutatingAdmissionPolicyBinding binds to. If the referenced resource does not exist, this binding is considered invalid and will be ignored Required.", alias="policyName")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "matchResources": V1alpha1MatchResources.from_dict(obj["matchResources"]) if obj.get("matchResources") is not None else None,
            "paramRef": V1alpha1ParamRef.from_dict(obj["paramRef"]) if obj.get("paramRef") is not None else None,

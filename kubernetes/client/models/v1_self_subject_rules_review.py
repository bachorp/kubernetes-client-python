...
class V1SelfSubjectRulesReview(BaseModel):
    ...
    status: Optional[V1SubjectRulesReviewStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1SelfSubjectRulesReviewSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1SubjectRulesReviewStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

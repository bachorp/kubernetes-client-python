...
class V1alpha2LeaseCandidateList(BaseModel):
    ...
    items: List[V1alpha2LeaseCandidate] = Field(description="items is a list of schema objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1alpha2LeaseCandidate.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),

...
class V1MatchResources(BaseModel):
    ...
    resource_rules: Optional[List[V1NamedRuleWithOperations]] = Field(default=None, description="ResourceRules describes what operations on what resources/subresources the ValidatingAdmissionPolicy matches. The policy cares about an operation if it matches _any_ Rule.", alias="resourceRules")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "excludeResourceRules": [V1NamedRuleWithOperations.from_dict(_item) for _item in obj["excludeResourceRules"]] if obj.get("excludeResourceRules") is not None else None,
            ...
            "resourceRules": [V1NamedRuleWithOperations.from_dict(_item) for _item in obj["resourceRules"]] if obj.get("resourceRules") is not None else None
        })
        return _obj

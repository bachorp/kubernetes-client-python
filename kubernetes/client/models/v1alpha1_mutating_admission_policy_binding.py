...
class V1alpha1MutatingAdmissionPolicyBinding(BaseModel):
    ...
    spec: Optional[V1alpha1MutatingAdmissionPolicyBindingSpec] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1alpha1MutatingAdmissionPolicyBindingSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        })
        return _obj

...
class V1ValidatingAdmissionPolicyBindingList(BaseModel):
    ...
    items: List[V1ValidatingAdmissionPolicyBinding] = Field(description="List of PolicyBinding.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1ValidatingAdmissionPolicyBinding.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),

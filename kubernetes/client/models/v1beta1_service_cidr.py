...
class V1beta1ServiceCIDR(BaseModel):
    ...
    spec: Optional[V1beta1ServiceCIDRSpec] = None
    status: Optional[V1beta1ServiceCIDRStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1beta1ServiceCIDRSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1beta1ServiceCIDRStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

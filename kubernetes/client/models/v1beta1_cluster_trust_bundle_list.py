...
class V1beta1ClusterTrustBundleList(BaseModel):
    ...
    items: List[V1beta1ClusterTrustBundle] = Field(description="items is a collection of ClusterTrustBundle objects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1beta1ClusterTrustBundle.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),

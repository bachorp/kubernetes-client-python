...
class V1HorizontalPodAutoscaler(BaseModel):
    ...
    spec: Optional[V1HorizontalPodAutoscalerSpec] = None
    status: Optional[V1HorizontalPodAutoscalerStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1HorizontalPodAutoscalerSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1HorizontalPodAutoscalerStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

...
class V1beta1ResourceSliceSpec(BaseModel):
    ...
    devices: Optional[List[V1beta1Device]] = Field(default=None, description="Devices lists some or all of the devices in this pool.  Must not have more than 128 entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "devices": [V1beta1Device.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None,
            ...
            "pool": V1beta1ResourcePool.from_dict(obj["pool"]) if obj.get("pool") is not None else None,
            "sharedCounters": [V1beta1CounterSet.from_dict(_item) for _item in obj["sharedCounters"]] if obj.get("sharedCounters") is not None else None
        })
        return _obj

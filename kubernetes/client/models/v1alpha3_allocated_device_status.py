...
class V1alpha3AllocatedDeviceStatus(BaseModel):
    ...
    """ # noqa: E501
    conditions: Optional[List[V1Condition]] = Field(default=None, description="Conditions contains the latest observation of the device's state. If the device has been configured according to the class and claim config references, the `Ready` condition should be True.  Must not contain more than 8 entries.")
    data: Optional[Dict[str, Any]] = Field(default=None, description="Data contains arbitrary driver-specific data.  The length of the raw data must be smaller or equal to 10 Ki.")
    ...
    network_data: Optional[V1alpha3NetworkDeviceData] = Field(default=None, alias="networkData")
    ...
    __properties: ClassVar[List[str]] = ["conditions", "data", "device", "driver", "networkData", "pool"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "networkData": V1alpha3NetworkDeviceData.from_dict(obj["networkData"]) if obj.get("networkData") is not None else None,
            "pool": obj.get("pool")
        })
        return _obj

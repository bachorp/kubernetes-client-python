...
class V1IPAddressList(BaseModel):
    ...
    items: List[V1IPAddress] = Field(description="items is the list of IPAddresses.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1IPAddress.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),

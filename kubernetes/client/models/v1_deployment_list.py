...
class V1DeploymentList(BaseModel):
    ...
    items: List[V1Deployment] = Field(description="Items is the list of Deployments.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1Deployment.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),

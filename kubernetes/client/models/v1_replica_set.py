...
class V1ReplicaSet(BaseModel):
    ...
    spec: Optional[V1ReplicaSetSpec] = None
    status: Optional[V1ReplicaSetStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1ReplicaSetSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1ReplicaSetStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

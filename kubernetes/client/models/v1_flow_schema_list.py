...
class V1FlowSchemaList(BaseModel):
    ...
    items: List[V1FlowSchema] = Field(description="`items` is a list of FlowSchemas.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1FlowSchema.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),

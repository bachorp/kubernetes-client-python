...
class V1ServiceCIDRList(BaseModel):
    ...
    items: List[V1ServiceCIDR] = Field(description="items is the list of ServiceCIDRs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1ServiceCIDR.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),

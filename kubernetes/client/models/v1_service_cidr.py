...
class V1ServiceCIDR(BaseModel):
    ...
    spec: Optional[V1ServiceCIDRSpec] = None
    status: Optional[V1ServiceCIDRStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1ServiceCIDRSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1ServiceCIDRStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

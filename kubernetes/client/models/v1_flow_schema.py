...
class V1FlowSchema(BaseModel):
    ...
    spec: Optional[V1FlowSchemaSpec] = None
    status: Optional[V1FlowSchemaStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1FlowSchemaSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1FlowSchemaStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

...
class V1beta2DeviceRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "exactly": V1beta2ExactDeviceRequest.from_dict(obj["exactly"]) if obj.get("exactly") is not None else None,
            "firstAvailable": [V1beta2DeviceSubRequest.from_dict(_item) for _item in obj["firstAvailable"]] if obj.get("firstAvailable") is not None else None,
            "name": obj.get("name")
        })
        return _obj

...
class V1ComponentStatusList(BaseModel):
    ...
    items: List[V1ComponentStatus] = Field(description="List of ComponentStatus objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1ComponentStatus.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),

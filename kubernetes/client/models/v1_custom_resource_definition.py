...
class V1CustomResourceDefinition(BaseModel):
    ...
    status: Optional[V1CustomResourceDefinitionStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1CustomResourceDefinitionSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1CustomResourceDefinitionStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

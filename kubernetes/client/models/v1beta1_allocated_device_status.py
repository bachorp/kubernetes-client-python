...
class V1beta1AllocatedDeviceStatus(BaseModel):
    ...
    network_data: Optional[V1beta1NetworkDeviceData] = Field(default=None, alias="networkData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "networkData": V1beta1NetworkDeviceData.from_dict(obj["networkData"]) if obj.get("networkData") is not None else None,
            "pool": obj.get("pool")
        })
        return _obj

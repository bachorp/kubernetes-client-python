...
class V1ClusterRoleList(BaseModel):
    ...
    items: List[V1ClusterRole] = Field(description="Items is a list of ClusterRoles")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1ClusterRole.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),

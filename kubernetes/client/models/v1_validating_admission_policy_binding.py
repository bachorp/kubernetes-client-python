...
class V1ValidatingAdmissionPolicyBinding(BaseModel):
    ...
    spec: Optional[V1ValidatingAdmissionPolicyBindingSpec] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1ValidatingAdmissionPolicyBindingSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        })
        return _obj

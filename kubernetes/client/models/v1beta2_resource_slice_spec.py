...
class V1beta2ResourceSliceSpec(BaseModel):
    ...
    devices: Optional[List[V1beta2Device]] = Field(default=None, description="Devices lists some or all of the devices in this pool.  Must not have more than 128 entries.")
    ...
    shared_counters: Optional[List[V1beta2CounterSet]] = Field(default=None, description="SharedCounters defines a list of counter sets, each of which has a name and a list of counters available.  The names of the SharedCounters must be unique in the ResourceSlice.  The maximum number of counters in all sets is 32.", alias="sharedCounters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "devices": [V1beta2Device.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None,
            ...
            "pool": V1beta2ResourcePool.from_dict(obj["pool"]) if obj.get("pool") is not None else None,
            "sharedCounters": [V1beta2CounterSet.from_dict(_item) for _item in obj["sharedCounters"]] if obj.get("sharedCounters") is not None else None
        })
        return _obj

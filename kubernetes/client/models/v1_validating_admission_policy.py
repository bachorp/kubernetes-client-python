...
class V1ValidatingAdmissionPolicy(BaseModel):
    ...
    spec: Optional[V1ValidatingAdmissionPolicySpec] = None
    status: Optional[V1ValidatingAdmissionPolicyStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1ValidatingAdmissionPolicySpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1ValidatingAdmissionPolicyStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

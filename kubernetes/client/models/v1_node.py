...
class V1Node(BaseModel):
    ...
    spec: Optional[V1NodeSpec] = None
    status: Optional[V1NodeStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1NodeSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1NodeStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

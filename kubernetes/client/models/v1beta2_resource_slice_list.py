...
class V1beta2ResourceSliceList(BaseModel):
    ...
    items: List[V1beta2ResourceSlice] = Field(description="Items is the list of resource ResourceSlices.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1beta2ResourceSlice.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),

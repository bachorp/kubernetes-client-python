...
class V1alpha3DeviceCounterConsumption(BaseModel):
    """
    DeviceCounterConsumption defines a set of counters that a device will consume from a CounterSet.
    """ # noqa: E501
    counter_set: StrictStr = Field(description="CounterSet defines the set from which the counters defined will be consumed.", alias="counterSet")
    counters: Dict[str, V1alpha3Counter] = Field(description="Counters defines the Counter that will be consumed by the device.  The maximum number counters in a device is 32. In addition, the maximum number of all counters in all devices is 1024 (for example, 64 devices with 16 counters each).")

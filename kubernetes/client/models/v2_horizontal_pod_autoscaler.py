...
class V2HorizontalPodAutoscaler(BaseModel):
    ...
    spec: Optional[V2HorizontalPodAutoscalerSpec] = None
    status: Optional[V2HorizontalPodAutoscalerStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V2HorizontalPodAutoscalerSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V2HorizontalPodAutoscalerStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

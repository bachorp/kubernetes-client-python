...
class V1beta1DeviceRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "firstAvailable": [V1beta1DeviceSubRequest.from_dict(_item) for _item in obj["firstAvailable"]] if obj.get("firstAvailable") is not None else None,
            "name": obj.get("name"),
            "selectors": [V1beta1DeviceSelector.from_dict(_item) for _item in obj["selectors"]] if obj.get("selectors") is not None else None,
            "tolerations": [V1beta1DeviceToleration.from_dict(_item) for _item in obj["tolerations"]] if obj.get("tolerations") is not None else None
        })
        return _obj

...
class V1alpha3ResourceClaimStatus(BaseModel):
    ...
    devices: Optional[List[V1alpha3AllocatedDeviceStatus]] = Field(default=None, description="Devices contains the status of each device allocated for this claim, as reported by the driver. This can include driver-specific information. Entries are owned by their respective drivers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "devices": [V1alpha3AllocatedDeviceStatus.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None,

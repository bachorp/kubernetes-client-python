...
class V1beta2DeviceCounterConsumption(BaseModel):
    ...
    """ # noqa: E501
    counter_set: StrictStr = Field(description="CounterSet is the name of the set from which the counters defined will be consumed.", alias="counterSet")
    counters: Dict[str, V1beta2Counter] = Field(description="Counters defines the counters that will be consumed by the device.  The maximum number counters in a device is 32. In addition, the maximum number of all counters in all devices is 1024 (for example, 64 devices with 16 counters each).")

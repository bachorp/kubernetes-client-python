...
class V1alpha3Device(BaseModel):
    ...
    """ # noqa: E501
    basic: Optional[V1alpha3BasicDevice] = None
    ...
    __properties: ClassVar[List[str]] = ["basic", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "basic": V1alpha3BasicDevice.from_dict(obj["basic"]) if obj.get("basic") is not None else None,
            "name": obj.get("name")
        })
        return _obj
